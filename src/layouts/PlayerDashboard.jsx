...
import {PImageUploadModal} from "./component/PImageUploadModal.jsx";
...
export function PlayerDashboard() {
    ...
    return (
        <>
                        ...
                        <div className="grid grid-cols-3 grid-rows-1 gap-4 ">
                            ...
                            <div className="grid gap-3 md:grid-cols-1 xl:grid-cols-1 justify-center items-center">
                                <div className="flex flex-col items-center justify-center rounded-lg bg-slate-800 p-8 shadow-xs">
                                    ...
                                    <div>
                                        <p className="mb-2 text-sm font-medium text-gray-300">
                                            <button onClick={handleOpenModal}>Uplaod Image</button>
                                        </p>
                                        {showModal && (
                                            <PImageUploadModal handleCloseModal={handleCloseModal} setPlayerStats={setPlayerStats}/>
                                        )}
            ...
            {showModal && (
                <PImageUploadModal handleCloseModal={handleCloseModal}/>
            )}
