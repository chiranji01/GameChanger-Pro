...
export function ImageUploadModal({ handleCloseModal, setPlayerStats }) {
    ...
    const handleGenerateReport = () => {
        ...
        const descriptionText = description || "A sweep is a cross-batted front foot shot played to a low bouncing ball or slow full toss. It is played by sweeping the ball around to the leg side, typically towards square leg or fine leg. Sweep shot is a popular and efficient shot in cricket. It is usually hit on spinners in order to rotate the strike.";
        ...
        // Display description text as a paragraph
        const descriptionLines = pdf.splitTextToSize(descriptionText, 190);
        const descriptionPara = descriptionLines.join("\n");
        pdf.text(descriptionPara, 10, 60);
        
        const imgData = uploadedImage;
        pdf.addImage(imgData, 'JPEG', 10, 80, 180, 100);
        
        pdf.save("Shot Recognition Report.pdf");
    };
